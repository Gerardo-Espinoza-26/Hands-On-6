...
public class HandsOn6 extends Agent {
    ...
    public void ImpimirMatriz(double[][] x) {
    ...
    }//Fin public void ImprimirMatriz
    ...
    }//Fin public double yield

    public void setup(){
        
        HandsOn6 tabla = new HandsOn6();

        tabla.ImpimirMatriz(tabla.getMatrizX());
        System.out.print("\n");

        tabla.TranspuestaMatriz(tabla.getMatrizX());
        tabla.ImpimirMatriz(tabla.getTranspuesta());
        System.out.print("\n");

        tabla.ProductoMatriz(tabla.getTranspuesta(), tabla.getMatrizX());
        tabla.ImpimirMatriz(tabla.getProducto());

        tabla.InversaMatriz(tabla.getProducto());
        tabla.ImpimirMatriz(tabla.getInversa());
        System.out.print("\n");

        tabla.ProductoMatriz(tabla.getTranspuesta(), tabla.getMatrizY());
        tabla.ImpimirMatriz(tabla.getProducto());
        System.out.print("\n");

        tabla.ProductoMatriz(tabla.getInversa(), tabla.getProducto());
        tabla.ImpimirMatriz(tabla.getProducto());
